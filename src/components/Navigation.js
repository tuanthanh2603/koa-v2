...
export default function Navigation() {
                ...
                featured: [
                    {
                        name: 'Dự án 1',
                        href: '#',
                        imageSrc: 'https://koastudio.vn/wp-content/uploads/1-25.jpg',
                    },
                    {
                        name: 'Dự án 2',
                        href: '#',
                        imageSrc: 'https://koastudio.vn/wp-content/uploads/RECEP_2.jpg',
                    },
                    {
                        name: 'Dự án 3',
                        href: '#',
                        imageSrc: 'https://koastudio.vn/wp-content/uploads/6-24.jpg',
                    },
                    {
                        name: 'Dự án 4',
                        href: '#',
                        imageSrc: 'https://koastudio.vn/wp-content/uploads/1-27.jpg',
                    },
                ],
                sections: [
                    {
    ...
    const handlePrev = () => {
        ...
        if (currentSlide > 0) {
            ...
            currentSlide = navigation.categories[0].featured.length - visibleSlides; // Get featured length from categories
        }
        slider.style.transform = `translateX(-${currentSlide * 50}%)`;
    };
    ...
    return (
        <div className="bg-white">
            {/* Mobile menu */}
            <Dialog open={open} onClose={setOpen} className="relative z-400 lg:hidden">
                <DialogBackdrop
                    transition
                                                    ...
                                                    <div className="mx-auto max-w-7xl px-8">
                                                        <div className="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                                                            <div className="relative overflow-hidden w-full">
                                                                ...
                                                                >
                                                                    {navigation.categories[0].featured.map((item) => (
                                                                        <div key={item.name} className="w-1/2 flex-shrink-0 px-4">
                                                                            <div className="group relative text-base sm:text-sm">
                                                                                <div className="w-full h-64 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75"> {/* Fixed size for square */}
                                                                                    <img
                                                                                        alt="Image project"
                                                                                        src={item.imageSrc}
                                                                                ...
                                                                                <a href={item.href} className="mt-6 block font-medium text-gray-900 text-center"> {/* Center the text */}
                                                                                    <span aria-hidden="true" className="absolute inset-0 z-10" />
                                                                                    {item.name}
                                                                                </a>
                                                                            </div>
                                                            ...
                                                            <div className="row-start-1 grid grid-cols-2 gap-x-1 gap-y-1 text-sm">
                                                                {solutions.map((item) => (
                                                                    <div key={item.name} className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50 shadow-sm cursor-pointer">
                                                    ...
                                                    <div className="mx-auto max-w-7xl px-8">
                                                        <div className="grid grid-cols-4 gap-x-8 gap-y-10 py-16">
                                                            <div className="p-6 border-2 border-gray-200 rounded-lg shadow-md hover:shadow-lg hover:border-yellow-600 transition">
                                                                <a href="/bao-gia-xay-nha-tron-goi" className="block text-lg font-semibold text-black hover:text-yellow-600">
                                                                    Báo giá xây nhà trọn gói
                                                                </a>
                                                                <p className="mt-2 text-sm text-gray-600">Chi tiết về báo giá xây nhà trọn gói, bao gồm các dịch vụ và chi phí liên quan.</p>
                                                            </div>
                                                            <div className="p-6 border-2 border-gray-200 rounded-lg shadow-md hover:shadow-lg hover:border-yellow-600 transition">
                                                                <a href="/bao-gia-hoan-thien" className="block text-lg font-semibold text-black hover:text-yellow-600">
                                                                    Báo giá hoàn thiện
                                                                </a>
                                                                <p className="mt-2 text-sm text-gray-600">Thông tin về báo giá hoàn thiện nhà, từ nội thất đến ngoại thất.</p>
                                                            </div>
                                                            <div className="p-6 border-2 border-gray-200 rounded-lg shadow-md hover:shadow-lg hover:border-yellow-600 transition">
                                                                <a href="/bao-gia-xay-dung-phan-tho" className="block text-lg font-semibold text-black hover:text-yellow-600">
                                                                    Báo giá xây dựng phần thô
                                                                </a>
                                                                <p className="mt-2 text-sm text-gray-600">Chi tiết về báo giá xây dựng phần thô, bao gồm các công đoạn và chi phí.</p>
                                                            </div>
                                                            <div className="p-6 border-2 border-gray-200 rounded-lg shadow-md hover:shadow-lg hover:border-yellow-600 transition">
                                                                <a href="/bao-gia-thiet-ke" className="block text-lg font-semibold text-black hover:text-yellow-600">
                                                                    Báo giá thiết kế
                                                                </a>
                                                                <p className="mt-2 text-sm text-gray-600">Thông tin về báo giá thiết kế, bao gồm các gói dịch vụ và chi phí.</p>
                                                            </div>
                                                        </div>
